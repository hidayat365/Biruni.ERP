 ...
 *
 * The followings are the available columns in table 'project_categories':
 * @property integer $id
...
class ProjectCategory extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'projects' => array(self::HAS_MANY, 'Projects', 'category_id'),
			'branch' => array(self::BELONGS_TO, 'Branches', 'branch_id'),
			'parent' => array(self::BELONGS_TO, 'ProjectCategory', 'parent_id'),
			'projectCategories' => array(self::HAS_MANY, 'ProjectCategory', 'parent_id'),
		);
	}
